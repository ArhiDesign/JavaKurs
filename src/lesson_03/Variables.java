...
public class Variables {
    public static void main(String[] args) {
        ...
        byteVariable = 45 ;
        System.out.println("начение переменной byteVariable: " + byteVariable);
        ...
        long longVar = 2_100_000_000_000L; // знак _ не влияет на значение переменной Для улучшения читаем
        // L вконце числа явным образом указать что число в формате long
